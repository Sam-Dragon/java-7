...
- It is one level above encapsulation, in simple terms it controls what needs to be displayed
...
3. Interface can only Exception another interface

> Steps to achieve 'HAS-A' relationship

1. Class must contain the reference of another class in form of variable
...
3. Sub Class must be overridden the Super class method
