...
class DeepCloningAddress implements Cloneable {

    String street;
    String house_number;

    public DeepCloningAddress(String street, String house_number) {
        this.street = street;
...
class DeepCloningClass implements Cloneable {

    String name;
    String description;
    DeepCloningAddress address;

    public DeepCloningClass(String name, String description, DeepCloningAddress address) {
        this.name = name;
    ...
    public DeepCloningAddress getAddress() {
        return address;
    }

    public void setAddress(DeepCloningAddress address) {
        this.address = address;
    }
    ...
    protected Object clone()
            throws CloneNotSupportedException {
        DeepCloningClass cloned = (DeepCloningClass) super.clone(); // shallow copy first
        cloned.address = (DeepCloningAddress) address.clone(); // deep copy
        return cloned;
    }
}

public class DeepCloningUsingCloneMethod {

    public static void main(String[] args)
            throws CloneNotSupportedException {
        DeepCloningAddress address = new DeepCloningAddress("8th main road", "12");
        DeepCloningClass actualObject = new DeepCloningClass("Deep Cloning", "Default Type Of Cloning",
                address);
        System.out.println("Actual Object Reference :: " + actualObject.hashCode());
        System.out.println("Actual Object Content :: " + actualObject);

        DeepCloningClass clonedObject = (DeepCloningClass) actualObject.clone();
