package learn.serilization.mulitple.hierarchy.parent.not.serialized.child.serialized;
...
public class DeSerilizationMultipleObjects {
	...
	public static void main(String[] args) {
		String fileName = "parentNotSerializedChildSerializedSerialization.ser";
